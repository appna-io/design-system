...
Target: **< 1 KB gz combined** for `Stack + HStack + VStack + Spacer`. No state, no effects, no
icons; only a tiny pure transform (`stackChildrenWithDivider`) and a literal-class gap resolver.
