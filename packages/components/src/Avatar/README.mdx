...
that logic across the consuming app. Reach for it whenever a screen needs to represent a person
or entity: comment threads, member lists, assignee chips, mention pickers, hero profile sections.
...
<ExampleBlock for="Basic" title="Basic — image, fallback initials, default icon" />
