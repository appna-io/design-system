...
When wrapped in `<I18nProvider>` (Phase 27, not yet shipped), Field will source these strings
from the active locale bundle. Until then, the defaults below are hardcoded English:
